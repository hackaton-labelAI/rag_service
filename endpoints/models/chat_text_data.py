...
class ChatTextData(BaseModel):
    ...
    ChatTextData
    """ # noqa: E501
    role: Optional[StrictStr] = Field(default=None, description="Role in the chat")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ChatTextData from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ChatTextData from a dict"""
        if obj is None:
            return None
